      ...
      <div>
        <div class="brand-logo d-flex align-items-center justify-content-between">
          <a href="../../dashboard/dash.php" class="text-nowrap logo-img">
            <img src="../assets/images/logos/lorafish.png" width="180" alt="" />
          </a>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="./shop-resource.php" aria-expanded="false">
                <span>
      ...
      <header class="app-header">
        <nav class="navbar navbar-expand-lg navbar-light">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link nav-icon-hover" href="./cart.php">
              <i class="ti-shopping-cart"></i>
                <div class="notification  rounded-circle" style="background-color: #11999e"></div>
              </a>
            </li>
          </ul>
