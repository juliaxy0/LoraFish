    ...
    <div class="container-fluid">
        <div class="mb-4">
            <div class="row">
                ...
                <body>
  <!-- Tank Prediction -->
<div class="col-lg-4" style="width: 60rem; padding-left:200px;">
    <div class="card overflow-hidden">
        <div class="card-body p-4" style="height: 22rem; width: 120rem;">
            ...
            <div class="table-responsive">
                <table class="table text-nowrap mb-0 align-middle">
                    <tbody>
                        <?php
                        // Load the tank predictions from the JSON file
                        $json_predictions = file_get_contents('tank_predictions.json');
                        $predictions = json_decode($json_predictions, true);
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="border-bottom-0">
                                    <div class="d-flex align-items-center gap-2">
                                        <span class="fw-semibold mb-0">Percentage Above Threshold:</span>
