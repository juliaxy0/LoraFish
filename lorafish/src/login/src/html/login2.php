        ...
        if (true) {
            ...
            if ($password == $users1['password']) {
                if ($_POST['category'] == $users1['category']) {
                    ...
                    setCookieValue("email", $_POST['email'], time() + (86400 * 30)); // Cookie expires in 30 days
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                if (isset($_POST['signIN_button'])) {
                                    ...
                                    if ($message == "noverify") {
                                        echo '<div class="alert alert-danger" role="alert">';
                                        echo 'Your emaill address is not verified! ';
                                        echo ' <a href="verifyregister.php" class="btn btn-link">Let\'s verify here</a>';
                                        echo '</div>';
                                    } else 
                                    ...
                                    <div class="d-flex ">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <a class="text-primary fw-bold " href="./register.php">Sign Up</a>
                                            </div>
                                            <div class="col">
