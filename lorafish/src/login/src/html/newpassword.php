...
<body>
    ...
    if (isset($_POST['update_button'])) {
        ...
        //end to check exist email


            //start to update new password
        if (isset($users1['name'])) {
            $newPassword = md5($_POST['new_password']);

            $stmt = $conn->prepare("UPDATE USERS1 SET password = :newPassword WHERE email = :email");
                ...
                <div class="row justify-content-center w-100">
                  ...
                  <img src="../assets/images/logos/dark-logo.svg" width="180" alt="">
                                ...
                                <form action="newpassword.php" method="POST">
                                    ...
                                    <input type="submit" class="btn btn-primary w-100 py-8 fs-4 mb-4 rounded-2" value="Change Password" name="update_button">
