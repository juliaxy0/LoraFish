...
<body>
    ...
    function sendemail_verify($email, $verification_token)
    {
        ...
        if (isset($test)) {
            ...
            try {
                ...
                $message = 'Hello,<br><br>' .
                    'Thank you register to our system. Please use the following verification key to verify your email address:<br><br>' .
    ...
    if (isset($_POST['re-send_button'])) {
        ...
        $stmt = $conn->prepare(
            "UPDATE USERS1 SET verification_token = :verification_token, isverify = '1' WHERE email = :email"
        );
        ...
        echo " " . $users1['verification_token'];
    }
    ...
    if (isset($_POST['verify_button'])) {
        ...
        if (isset($users1['verification_token'])) {
            if ($users1['verification_token'] == $_POST['verification_token']) {

                $message = "correcttoken";

                $stmt = $conn->prepare("UPDATE USERS1 SET isverify = 1 WHERE email = :email");
                $stmt->bindParam(':email', $email);
                $stmt->execute();
            } else {
                $message = "wrongtoken";
                                ...
                                <div class="row">
                                    ...
                                    if (isset($_POST['verify_button'])) {
                                        ...
                                        if ($message == "correcttoken") {
                                            ...
                                            if ($message == "wrongtoken") {
                                            echo '<div class="alert alert-danger" role="alert">';
                                            echo 'Your verification key is incorrect!';
                                            echo '</div>';
                                        } else if ($message == "wrongemail") {
                                            echo '<div class="alert alert-danger" role="alert">';
                                ...
                                <form action="verifyregister.php" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-4">
                                                <input type="submit" class="btn btn-primary w-10 py-8 fs-4 mb-4 rounded-2 me-2 pr-5" value="Re-send" name="re-send_button">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="verification_token" class="form-control" id="exampleInputPassword1">

                                    </div>

                                    <input type="submit" class="btn btn-primary w-100 py-8 fs-4 mb-4 rounded-2" value="Verify your email address" name="verify_button">
