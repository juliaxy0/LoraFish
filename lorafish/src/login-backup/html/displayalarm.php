                      ...
                      $stmt->execute();
                        ...
                        foreach($alarm as $alarm)
                        {
                          ...
                          <td>" . number_format($alarm["minOxygenLevel"], 1) . " - " . number_format($alarm["maxOxygenLevel"], 1) . "</td>
                                                                  ...
                                                                  <td>" . number_format($alarm["minCarbonDioxideLevel"], 1) . " - " . number_format($alarm["maxCarbonDioxideLevel"], 1) . "</td>
                                                                  <td>" . number_format($alarm["minTemperatureLevel"], 1) . " - " . number_format($alarm["maxTemperatureLevel"], 1) . "</td>
