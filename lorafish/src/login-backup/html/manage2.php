...
<body>
    ...
    if (isset($_POST['update'])) {
        ...
        SET minAcidityLevel = :minacidity , maxAcidityLevel= :maxacidity, minOxygenLevel = :minoxygen , maxOxygenLevel= :maxoxygen, minHydrogenLevel = :minhydrogen , maxNitrateLevel= :maxnitrate, minCarbonDioxidenLevel = :mincarbondioxide , maxCarbonDioxideLevel= :maxcarbondioxide, minTemperatureLevel = :mintemperature , maxTemperatureLevel= :maxtemperature,
        WHERE tankNo = :tankNo;");
                            ...
                            <form action="manage2.php" method="POST">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="container">
                                        ...
                                        <button class="btn btn-primary me-md-2 float-end" name="update" type="button">Update</button>
                                    </div>
