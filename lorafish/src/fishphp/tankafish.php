      ...
      <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="./tankafish.php" aria-expanded="false">
                <span>
              ...
              <div class="card-body">
                ...
                <div class="card">
                  <div class="card-body p-4">
                    <button type="button" data-tank="A" class="btn btn-primary m-2" style="background-color: #020E5D; border: 2px solid black; font-size:20px; padding: 35px 60px;text-align: center; margin: 4px 2px">Tank A</button>
...
<script>
  ...
  $(document).ready(function(){
      $.ajax({
          type: "GET",
          url: "../marinelife/marinelifetanka.php",
          dataType: 'json',
  ...
  $.ajax({
    type: "GET",
    url: "../marinelife/tilapiafishdata.php",
    dataType: 'json',
    success: function(data) {
      var response = "";
      for (var i = 0; i < Object.keys(data).length; i++) {
        response += "<tr style=\"text-align: center;\">" +
          ...
          "<td class=\"border-bottom-0\">" +
          "<button type=\"button\" class=\"btn btn-info m-1\" onclick=\"location.href='updateFish.php?fishID=" + data[i].fishID + "';\">Edit</button>" +
          "</td>" +
          "</tr>";
      }
...
<script>
  ...
  window.location.href = 'createfish.php';
}
</script>
